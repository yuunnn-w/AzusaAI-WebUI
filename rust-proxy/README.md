...
|---|---|---|---|---|
| **开源版**（不注入） | `azusa-local-proxy-win7-x64.exe` | `http://127.0.0.1:8080` | 1,477,120 | `192b9336aec4b3ccc672b306be83ef9e284ea31bbda5479421060c6b6cf5fc89` |
| **内网版**（注入） | `azusa-local-proxy-win7-x64-internal.exe` | 构建时注入的内网地址 | 1,477,120 | `d95a33a1d38683c89718dd31ede39141c04acb174ddd6b4c60554292ebc12a13` |
