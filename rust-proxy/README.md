...
|---|---|---|---|---|
| **开源版**（不注入） | `azusa-local-proxy-win7-x64.exe` | `http://127.0.0.1:8080` | 1,477,120 | `e4c656737fe826b42e3b7bede2170bb42715686d3947773638d52bed8619cef7` |
| **内网版**（注入） | `azusa-local-proxy-win7-x64-internal.exe` | 构建时注入的内网地址 | 1,477,120 | `61b027986eedde5e67d243188dda30f5fd0141cce71f72a00b51a19b1b011083` |
